...
Just [clone](github-windows://openRepo/https://github.com/elurye/rejestBoiler) or [fork](https://github.com/elurye/rejestBoiler/fork) the repo and start hacking:

```shell
$ git clone -o upstream https://github.com/elurye/rejestBoiler.git react-jest-app
$ cd react-jest-app
